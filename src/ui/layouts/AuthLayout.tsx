...
export default function AuthLayout() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-aurora text-white flex items-center justify-center transition-all duration-700">
      ...
      <div className="relative z-10 flex w-full max-w-6xl h-[550px] rounded-3xl overflow-hidden shadow-2xl backdrop-blur-xl border border-white/10">
        {/* Bên giới thiệu */}
        <motion.div
