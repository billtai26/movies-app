      ...
      <div className="relative flex min-h-screen w-screen flex-col md:flex-row">
        ...
        <div className="relative flex-1 overflow-hidden">
          <form
            ...
            className={`absolute inset-0 flex items-center justify-center p-8 md:p-12 transition-all duration-700 ease-[cubic-bezier(0.4,0,0.2,1)]
              ${mode==='login' ? 'translate-x-0 opacity-100' : '-translate-x-full opacity-0 pointer-events-none'}`}
          >
          ...
          <form
            ...
            className={`absolute inset-0 flex items-center justify-center p-8 md:p-12 transition-all duration-700 ease-[cubic-bezier(0.4,0,0.2,1)]
              ${mode==='register' ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0 pointer-events-none'}`}
          >
            <div className="w-full max-w-md">
