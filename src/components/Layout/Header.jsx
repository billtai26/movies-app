      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="hidden md:block">
            ...
            <p>Welcome back, Tài! Here's what's happening today </p>
          </div>
        </div>
        ...
        <div className="flex-1 max-w-md mx-8">
          <div className="relative">
            <Search className="w-4 h-4 absolute left-3 top-1/2 transform -translate-y-1/2 text-slat-400 " />
            <input
              type="text"
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="flex items-center space-x-3 pl-3 border-l border-slate-200 dark:border-slate-700">
            <img
              src="https://res.cloudinary.com/dyxvjfily/image/upload/v1747976020/users/qbxpqdkrufhgo5mmppef.jpg"
              alt="User"
