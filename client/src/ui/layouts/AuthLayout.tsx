...
export default function AuthLayout() {
  ...
  return (
  <div className="relative min-h-screen overflow-hidden bg-aurora text-white flex items-center justify-center transition-all duration-700 px-4 py-8">
  ...
  <div className="relative z-10 flex w-full max-w-6xl flex-col md:flex-row md:h-[550px] rounded-3xl overflow-hidden shadow-2xl backdrop-blur-xl border border-white/10">
        {/* Bên giới thiệu */}
        <motion.div
        ...
        {/* Bên form */}
        <div className="flex-1 flex items-center justify-center relative p-4 md:p-0">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              exit={{ x: isLogin ? "100%" : "-100%", opacity: 0 }}
              transition={{ duration: 0.8, ease: "easeInOut" }}
              className="w-full max-w-sm p-6 md:p-8 mx-auto bg-white/5 rounded-xl"
            >
              <Outlet />
            </motion.div>
          </AnimatePresence>
